...
botStart = time.time()
cl = LINE("hrwghnayw@whkart.com", "djry9420")
cl.log("Auth Token : " + str(cl.authToken))
print ("====機器壹登入成功====")
kl = LINE("imawfm@3nixmail.com", "djry9420")
kl.log("Auth Token : " + str(kl.authToken))
print ("====機器貳登入成功====")
sb = LINE("czohaoz@nixemail.net", "djry9420")
sb.log("Auth Token : " + str(kl.authToken))
print ("====機器參登入成功====")
kt = LINE("zsgnotlfs@wmail.com", "djry9420")
kt.log("Auth Token : " + str(kl.authToken))
print ("====機器肆登入成功====")
sa = LINE("cjzmixiw@whkart.com", "djry9420")
...
msg_dict = {}
bl = [""]
god = ['u663e2bfd447da72d0cc8f3f1648d1762']
#==========================================================================================#
